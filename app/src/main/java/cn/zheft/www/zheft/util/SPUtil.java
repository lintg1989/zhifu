...
public class SPUtil {
     ...
     * @param object
     */
    public static void putPublic(Context context, String key, Object object) {
     ...
     * @return
     */
    public static Object getPublic(Context context, String key, Object defaultObject) {
        SharedPreferences sp = context.getSharedPreferences(Config.FILE_NAME,
                Context.MODE_MULTI_PROCESS);
     ...
     * @return
     */
    public static boolean containsPublic(Context context, String key) {
        SharedPreferences sp = context.getSharedPreferences(Config.FILE_NAME,
                Context.MODE_MULTI_PROCESS);
        return sp.contains(key);
    }
